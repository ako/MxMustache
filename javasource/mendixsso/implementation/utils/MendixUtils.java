...
public final class MendixUtils {
    ...
    public static <T> List<T> retrieveFromDatabase(final IContext context, final Class<T> cls, final String xPathExpr,
                                                   final HashMap<String, Object> xPathVariables, Object... xPathArgs) throws RuntimeException {
    ...
    private static <T> T retrieveSingleObjectFromDatabase(final IContext context, final Class<T> cls, boolean expectSingleResult, final String xPathExpr,
        ...
        if (expectSingleResult && results.size() > 1) {
    ...
    public static <T> T retrieveSingleObjectFromDatabase(final IContext context, final Class<T> cls, final String xPathExpr,
                                                         final HashMap<String, Object> xPathVariables, Object... xPathArgs) {
        return retrieveSingleObjectFromDatabase(context, cls, true, xPathExpr, xPathVariables, xPathArgs);
    }
